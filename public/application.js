...
/***/ (function(module, exports, __webpack_require__) {
	...
	var turnCounter = function turnCounter() {
	  turnCount++;
	};
	// logic
	...
	var winByRow = function winByRow() {
	  if ($('#box0').text() === $('#box1').text() && $('#box1').text() === $('#box2').text() && $('#box0').text() !== '' || $('#box3').text() === $('#box4').text() && $('#box4').text() === $('#box5').text() && $('#box3').text() !== '' || $('#box6').text() === $('#box7').text() && $('#box7').text() === $('#box8').text() && $('#box6').text() !== '') {
	    console.log('row');
	    return true;
	  } else {
	    return false;
	...
	var winByCol = function winByCol() {
	  if ($('#box0').text() === $('#box3').text() && $('#box3').text() === $('#box6').text() && $('#box0').text() !== '' || $('#box1').text() === $('#box4').text() && $('#box4').text() === $('#box7').text() && $('#box1').text() !== '' || $('#box2').text() === $('#box5').text() && $('#box5').text() === $('#box8').text() && $('#box2').text() !== '') {
	    console.log('col');
	    return true;
	  } else {
	    return false;
	...
	var winByDiagonal = function winByDiagonal() {
	  if ($('#box4').text() === $('#box8').text() && $('#box8').text() === $('#box0').text() && $('#box4').text() !== '' || $('#box4').text() === $('#box2').text() && $('#box2').text() === $('#box6').text() && $('#box6').text() !== '') {
	    console.log('diag');
	    return true;
	  } else {
	    return false;
	...
	var winnerLog = function winnerLog() {
	  if (turnCount % 2 === 0) {
	...
	$('#new-game-button').on('click', function (event) {
	  event.preventDefault();
	  var data = {};
	  api.newGame(data).then(ui.newGameSuccess).catch(ui.failure);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var gameTally = function gameTally() {
	  console.log('hey');
	  return $.ajax({
	    url: config.apiOrigin.development + '/games',
	    method: 'GET',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getGameUpdates = function getGameUpdates() {
	  event.preventDefault();
	  // console.log(store.game.id)
	  api.gameTally().then(function (data) {
	    console.log(data);
	    console.log('Success');
	...
	var onUpdateGame = function onUpdateGame(letter, index, gameOver) {
	  var data = {
	    'game': {
	      'cell': {
	        'index': index,
